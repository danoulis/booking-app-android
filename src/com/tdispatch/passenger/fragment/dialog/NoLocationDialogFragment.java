 ...
 ******************************************************************************
*/
public class NoLocationDialogFragment extends TDDialogFragment
{
	...
	public static NoLocationDialogFragment newInstance(int type, String title, String msg) {
		return newInstance(type, title, msg, null);
	}

	public static NoLocationDialogFragment newInstance(int type, String title, String msg, String button) {

		NoLocationDialogFragment frag = new NoLocationDialogFragment();
	...
	protected void onPostCreateView() {
		...
		button.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick( View v ) {
				...
				try {
					TDApplication.getAppContext().startActivity(settingsIntent);
				} catch( Exception e ) {
					e.printStackTrace();
				}
			}
